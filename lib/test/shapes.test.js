...
describe('Square', () => {
  describe('render', () => {
    test('returns SVG string for square shape', () => {
      ...
      const resultStr =`<rect x="70" y="20" width="160" height="160" fill="blue" /><text x="150" y="120" font-size="60" text-anchor="middle" fill="white">LoL</text>`
...
describe('Triangle', () => {
  describe('render', () => {
    test('returns SVG string for triangle shape', () => {
      ...
      const resultStr =`<polygon points="150, 18 244, 182 56, 182" fill="blue" /><text x="150" y="150" font-size="60" text-anchor="middle" fill="white">LoL</text>`
